    ...
    <div className="container text-center mx-auto py-5 md:pb-10 px-4">
      ...
      <div className="bengali-text bg-gray-100 p-6 rounded-lg shadow-lg max-w-4xl mx-auto text-gray-900">
        ...
        <p className="text-base leading-7">
          ...
          নিশ্চিত করে যে, আপনি আমাদের কাছ থেকে সেরা এবং নির্ভরযোগ্য প্রোডাক্ট
          পাচ্ছেন। আমাদের গ্যাজেটগুলি সরাসরি বিশ্বস্ত ইম্পোর্টারদের মাধ্যমে আসে,
          এবং আমরা সর্বদা মান নিশ্চিত করে থাকি। আমাদের শপ থেকে কেনাকাটা করলে
          আপনি পাবেন মানের নিশ্চয়তা এবং পরিপূর্ণ গ্রাহকসেবা।
        </p>
      </div>
    </div>
  );
