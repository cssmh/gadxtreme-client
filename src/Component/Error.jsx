  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-teal-50 to-gray-100">
      <div className="text-center space-y-3 p-8 bg-white shadow-2xl rounded-2xl w-full max-w-md">
        ...
        <Link
          to="/"
          className="inline-block px-5 py-3 text-xl font-semibold text-white bg-teal-600 rounded-lg shadow-md hover:bg-teal-700 hover:shadow-lg transition-all duration-300"
        >
          Go to Homepage
        </Link>
      </div>
